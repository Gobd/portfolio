...
angular.module("app").controller("mainCtrl",["$scope","$document","$window","$interval",function(e,t,n,o){function l(t){var n=1,l=function(){e.tagLine=t.slice(0,n),n++},s=function(){return 50*Math.random()+70};o(l,s(),t.length)}e.scrollTo=function(e){var n=angular.element(document.getElementById(e));t.scrollToElement(n,50,200)},e.tagLine="";var s="Full Stack Web Developer | UI/UX | JavaScript";l(s),SVGElement.prototype.hasClass=function(e){return new RegExp("(\\s|^)"+e+"(\\s|$)").test(this.getAttribute("class"))},SVGElement.prototype.addClass=function(e){this.hasClass(e)||this.setAttribute("class",this.getAttribute("class")+" "+e)},SVGElement.prototype.removeClass=function(e){var t=this.getAttribute("class").replace(new RegExp("(\\s|^)"+e+"(\\s|$)","g"),"$2");this.hasClass(e)&&this.setAttribute("class",t)};var a=document.getElementsByTagName("svg"),r=angular.element(document.getElementById("about"))[0].offsetTop,c=angular.element(document.getElementById("skills"))[0].offsetTop,i=angular.element(document.getElementById("portfolio"))[0].offsetTop,u=document.getElementById("navAbout"),g=document.getElementById("navSkills"),d=document.getElementById("navPortfolio"),m=document.getElementById("navContact");e.pxScr=0,e.navStyle={color:"#ebeaea"},t.on("scroll",function(){e.$apply(function(){[].forEach.call(a,function(e){n.innerHeight-50>=e.getBoundingClientRect().top&&e.addClass("svgGrow"),(e.getBoundingClientRect().top<75&&e.hasClass("svgGrow")||e.getBoundingClientRect().top+100>n.innerHeight&&e.hasClass("svgGrow"))&&e.removeClass("svgGrow")}),e.pxScr=n.scrollY,e.pxScr>75?e.navStyle={color:"#131829"}:e.navStyle={color:"#ebeaea"},0===e.pxScr&&(u.style.textDecoration="none",g.style.textDecoration="none",d.style.textDecoration="none"),e.pxScr>r-65&&(u.style.textDecoration="underline",g.style.textDecoration="none",d.style.textDecoration="none"),e.pxScr>c-65&&(u.style.textDecoration="none",g.style.textDecoration="underline",d.style.textDecoration="none"),e.pxScr>i-65&&(u.style.textDecoration="none",g.style.textDecoration="none",d.style.textDecoration="underline"),n.innerHeight+t[0].body.scrollTop>=t[0].body.scrollHeight-50?(m.style.textDecoration="underline",d.style.textDecoration="none"):m.style.textDecoration="none"})})}]);
