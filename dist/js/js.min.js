...
angular.module("app").controller("mainCtrl",["$scope","$document","$window",function(e,t,n){e.scrollTo=function(e){var n=angular.element(document.getElementById(e));t.scrollToElement(n,50,200)};var o=angular.element(document.getElementById("about"))[0].offsetTop,l=angular.element(document.getElementById("skills"))[0].offsetTop;e.pxScr=0,document.getElementById("navAbout").style.textDecoration="underline",e.navStyle={color:"#ebeaea"},t.on("scroll",function(){e.$apply(function(){e.pxScr=n.scrollY,e.pxScr>75?e.navStyle={color:"#131829"}:e.navStyle={color:"#ebeaea"},e.pxScr>o-65&&e.pxScr<l-65?document.getElementById("navAbout").style.textDecoration="underline":document.getElementById("navAbout").style.textDecoration="none",e.pxScr>l-65?document.getElementById("navSkills").style.textDecoration="underline":document.getElementById("navSkills").style.textDecoration="none",n.innerHeight+t[0].body.scrollTop>=t[0].body.scrollHeight-50?(document.getElementById("navContact").style.textDecoration="underline",document.getElementById("navSkills").style.textDecoration="none"):document.getElementById("navContact").style.textDecoration="none"})})}]);
