...
angular.module("app").controller("mainCtrl",["$scope","$document","$window","$interval",function(e,t,n,o){function l(t){var n=1,l=function(){e.tagLine=t.slice(0,n),n++},r=function(){return 50*Math.random()+75};o(l,r(),t.length)}e.scrollTo=function(e){var n=angular.element(document.getElementById(e));t.scrollToElement(n,50,200)},e.tagLine="";var r="Full Stack Web Developer | UI/UX | JavaScript";l(r);var a=angular.element(document.getElementById("about"))[0].offsetTop,c=angular.element(document.getElementById("skills"))[0].offsetTop,i=angular.element(document.getElementById("portfolio"))[0].offsetTop,u=document.getElementById("navAbout"),s=document.getElementById("navSkills"),y=document.getElementById("navPortfolio"),d=document.getElementById("navContact");e.pxScr=0,e.navStyle={color:"#ebeaea"},t.on("scroll",function(){e.$apply(function(){e.pxScr=n.scrollY,e.pxScr>75?e.navStyle={color:"#131829"}:e.navStyle={color:"#ebeaea"},0===e.pxScr&&(u.style.textDecoration="none",s.style.textDecoration="none",y.style.textDecoration="none"),e.pxScr>a-65&&(u.style.textDecoration="underline",s.style.textDecoration="none",y.style.textDecoration="none"),e.pxScr>c-65&&(u.style.textDecoration="none",s.style.textDecoration="underline",y.style.textDecoration="none"),e.pxScr>i-65&&(u.style.textDecoration="none",s.style.textDecoration="none",y.style.textDecoration="underline"),n.innerHeight+t[0].body.scrollTop>=t[0].body.scrollHeight-50?(d.style.textDecoration="underline",y.style.textDecoration="none"):d.style.textDecoration="none"})})}]);
