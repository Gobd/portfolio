...
angular.module("app").controller("mainCtrl",["$scope","$document","$window",function(e,t,n){e.scrollTo=function(e){var n=angular.element(document.getElementById(e));t.scrollToElement(n,50,200)};var o=angular.element(document.getElementById("about"))[0].offsetTop,l=angular.element(document.getElementById("skills"))[0].offsetTop,r=angular.element(document.getElementById("portfolio"))[0].offsetTop,c=document.getElementById("navAbout"),a=document.getElementById("navSkills"),i=document.getElementById("navPortfolio"),y=document.getElementById("navContact");e.pxScr=0,e.navStyle={color:"#ebeaea"},t.on("scroll",function(){e.$apply(function(){e.pxScr=n.scrollY,e.pxScr>75?e.navStyle={color:"#131829"}:e.navStyle={color:"#ebeaea"},0===e.pxScr&&(c.style.textDecoration="none",a.style.textDecoration="none",i.style.textDecoration="none"),e.pxScr>o-65&&(c.style.textDecoration="underline",a.style.textDecoration="none",i.style.textDecoration="none"),e.pxScr>l-65&&(c.style.textDecoration="none",a.style.textDecoration="underline",i.style.textDecoration="none"),e.pxScr>r-65&&(c.style.textDecoration="none",a.style.textDecoration="none",i.style.textDecoration="underline"),n.innerHeight+t[0].body.scrollTop>=t[0].body.scrollHeight-50?(y.style.textDecoration="underline",i.style.textDecoration="none"):y.style.textDecoration="none"})})}]);
