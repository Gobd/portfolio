...
angular.module("app").controller("mainCtrl",["$scope","$document","$window",function(n,l,o){n.scrollTo=function(n){var o=angular.element(document.getElementById(n));l.scrollToElement(o,50,200)},n.pxScr=0,l.on("scroll",function(){n.$apply(function(){n.pxScr=o.scrollY})})}]);
